...
// Colors + typography + effects (radius) from the other four systems,
// loaded here purely so the gallery row card in gallery-data.ts can
// reference their real `--s-*`/`--b-*`/`--bb-*`/`--mo-*` tokens with var()
...
// names, so all five token sets can coexist at :root on this one page.
...
import "@/lib/design-systems/bloom/tokens/typography.css";
import "@/lib/design-systems/bloom/tokens/effects.css";
...
// shell. Slate/Bloom/bluebird each get their own root layout (see
