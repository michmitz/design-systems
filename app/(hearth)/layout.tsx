...
// Colors-only (no @import, no body-level rules) from the other four
// systems, loaded here purely so the gallery card in gallery-data.ts can
// reference their real `--v-*`/`--s-*`/`--b-*`/`--bb-*` tokens with var()
// instead of hand-copied hex. Their prefixes don't collide with each other or
// with Hearth's unprefixed --color-*/--bg-*/--text-* names, so all five token
...
// shell. Voltage/Slate/Bloom/bluebird each get their own root layout (see
...
export const metadata: Metadata = {
  ...
  description:
    "A small library of visual languages — colors, type, and foundations for Hearth, Voltage, Slate, Bloom, and bluebird.",
};
